package com.example.groceryhub.ui.theme.pages.products
...
import com.example.groceryhub.data.ProductRepository
...
fun UpdateProductsScreen(navController: NavHostController, id:String){
    Column (modifier = Modifier .fillMaxSize(),
        ...
        var currentDataRef = FirebaseDatabase.getInstance().getReference().child("Products/$id")
        ...
        Button(onClick = {
            ...
            productRepository.updateProducts(productName.text.trim(), productQuantity.text.trim(), productPrice.text.trim(), id)
